...
(function (global, factory) {
  ...
  function fire() {
    const Swal2 = this; // eslint-disable-line @typescript-eslint/no-this-alias
  ...
  Object.assign(SweetAlert2.prototype, instanceMethods); // Assign static methods from src/staticMethods/*.js to constructor

  Object.assign(SweetAlert2, staticMethods); // Proxy to instance methods to constructor, for now, for backwards compatibility
  ...
  SweetAlert2.version = '11.4.20';

  const Swal2 = SweetAlert2; // @ts-ignore
...
if (typeof this !== 'undefined' && this.Sweetalert2){  this.swal2 = this.sweetAlert2 = this.Swal2 = this.SweetAlert2 = this.Sweetalert2}
